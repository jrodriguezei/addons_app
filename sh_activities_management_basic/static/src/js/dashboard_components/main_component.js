...
import { ActivityTableDashboardView } from "@sh_activities_management_basic/js/dashboard_components/table_component";
import { ActivityCardsDashboardView } from "@sh_activities_management_basic/js/dashboard_components/cards_component";
...
registry.category("actions").add("sh_activities_management_basic_dashboard", ActivityDashboard, { force: true });